<div class="max-w-lg w-full grid grid-cols-5 justify-center text-center mx-auto py-4 px-4 bg-base-200">
    <a href="/">
        <svg class="size-8 mx-auto" data-slot="icon" fill="none" stroke-width="1.5" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
