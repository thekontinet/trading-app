<x-app-layout>
    ...
    <div class="py-4 lg:py-12">
        <div class="grid gap-4 mx-auto max-w-7xl px-2 lg:px-8">
            <div class="border border-primary bg-cover bg-center text-white text-center" :title="" subtitle="Trading Balance" style="background-image: url('/images/dashboard-wallet-card.png')">
