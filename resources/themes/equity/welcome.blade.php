<x-equity::layout.main-layout :navitems="$navitems" title="Welcom to {{env('APP_NAME')}}">
    <!-- slideshow content begin -->
    <div class="uk-section uk-padding-remove-vertical in-slideshow-gradient">
        <div id="particles-js" class="uk-light in-slideshow uk-background-contain" data-src="/themes/equity/img/in-equity-decor-1.svg" data-uk-img data-uk-slideshow>
            <hr>
            <ul class="uk-slideshow-items">
                <li class="uk-flex uk-flex-middle">
                    <div class="uk-container">
                        <div class="uk-grid-large uk-flex-middle" data-uk-grid>
                            <div class="uk-width-1-2@s in-slide-text@m">
                                <p class="in-badge-text uk-text-small uk-margin-remove-bottom uk-visible@m">
                                    <span class="uk-label uk-label-success in-label-small">New</span>
                                ...
                                <p class="uk-text-lead">Get the most accurate market data, alerts, conversions, tools and more — all within the same app.</p>
                                <div class="uk-grid-medium uk-child-width-1-3@m uk-child-width-1-2@s" data-uk-grid>
                                    <div>
                                        <div class="uk-card uk-card-small uk-card-secondary uk-card-body uk-border-rounded uk-flex uk-flex-middle">
                                            <div class="in-symbol-logo">
                                                <img src="/themes/equity/img/in-lazy.gif" data-src="/themes/equity/img/in-symbol-tesla.svg" alt="ticker" width="28" height="28" data-uk-img>
                                            </div>
                                    ...
                                    <div>
                                        <div class="uk-card uk-card-small uk-card-secondary uk-card-body uk-border-rounded uk-flex uk-flex-middle">
                                            <div class="in-symbol-logo">
                                                <img src="/themes/equity/img/in-lazy.gif" data-src="/themes/equity/img/in-symbol-google.svg" alt="ticker" width="28" height="28" data-uk-img>
                                            </div>
                                    ...
                                    <div class="uk-visible@m">
                                        <div class="uk-card uk-card-small uk-card-secondary uk-card-body uk-border-rounded uk-flex uk-flex-middle">
                                            <div class="in-symbol-logo">
                                                <img src="/themes/equity/img/in-lazy.gif" data-src="/themes/equity/img/in-symbol-apple.svg" alt="ticker" width="28" height="28" data-uk-img>
                                            </div>
                                            <div class="in-price up">
    ...
    <!-- section content end -->
    <!-- section content begin -->
    <div class="uk-section in-equity-2 uk-background-contain uk-background-center" data-src="/themes/equity/img/in-equity-2-bg.png" data-uk-img>
        <div class="uk-container uk-margin-top">
            <div class="uk-grid uk-flex uk-flex-center">
                ...
                <div class="uk-width-3-4@m uk-margin-medium-top">
                    <img class="uk-align-center" src="/themes/equity/img/in-lazy.gif" data-src="/themes/equity/img/in-equity-2-img.png" alt="image" width="758" height="334" data-uk-img>
                </div>
                    ...
                    <div class="uk-grid uk-child-width-1-4@m uk-child-width-1-4@s uk-text-center in-feature-box" data-uk-grid>
                        <a href="#">
								<span class="in-icon-wrap">
									<img src="/themes/equity/img/in-lazy.gif" data-src="/themes/equity/img/in-equity-2-icon-1.svg" alt="icon-1" width="35" height="42" data-uk-img>
								</span>
                            <p class="uk-margin-top">Trading calculators</p>
                        </a>
                        <a href="#">
								<span class="in-icon-wrap">
									<img src="/themes/equity/img/in-lazy.gif" data-src="/themes/equity/img/in-equity-2-icon-2.svg" alt="icon-2" width="38" height="42" data-uk-img>
								</span>
                            <p class="uk-margin-top">Market analysis</p>
                        </a>
                        <a href="#">
								<span class="in-icon-wrap">
									<img src="/themes/equity/img/in-lazy.gif" data-src="/themes/equity/img/in-equity-2-icon-3.svg" alt="icon-3" width="42" height="42" data-uk-img>
								</span>
                            <p class="uk-margin-top">Market reviews</p>
                        </a>
                        <a href="#">
								<span class="in-icon-wrap">
									<img src="/themes/equity/img/in-lazy.gif" data-src="/themes/equity/img/in-equity-2-icon-4.svg" alt="icon-4" width="42" height="42" data-uk-img>
								</span>
                ...
                <div class="uk-card uk-card-secondary uk-card-body uk-border-rounded uk-box-shadow-medium uk-background-contain uk-background-top-center" data-src="img/in-equity-12-bg.png" data-uk-img="">
                    <div class="uk-grid-small uk-child-width-1-2@m uk-grid" data-uk-grid="">
                        ...
                        <div class="uk-flex uk-flex-right uk-flex-middle button-app">
                            <a href="{{ route('register') }}" class="uk-button uk-button-primary uk-border-rounded uk-margin-left">Open account<i class="fas fa-arrow-circle-right uk-margin-small-left"></i></a>
                        </div>
                        <div class="uk-width-expand@m uk-grid-margin uk-first-column">
                            ...
                            <div class="uk-flex uk-flex-left uk-margin-top in-steps">
                                ...
                                <div class="uk-margin-right">
                                    ...
                                    <p class="uk-margin-small-top">Access 180+ instruments across all asset classes on our platform</p>
                                </div>
                            </div>
                        </div>
                        <div class="uk-width-3-5@m uk-grid-margin">
                            <img class="in-img-mockup" src="/themes/equity/img/in-equity-12-mockup.png" data-src="/themes/equity/img/in-equity-12-mockup.png" alt="mockup" width="636" height="436" data-uk-img="">
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="uk-container uk-margin-medium-bottom">
            <div class="uk-grid uk-flex uk-flex-center">
                <div class="uk-margin-medium-top">
                    <div class="uk-card uk-card-default uk-card-body uk-border-rounded uk-flex uk-flex-center">
                        <ul class="uk-subnav uk-subnav-divider" data-uk-margin="">
                            @if(env('APP_PHONE'))
                                <li class="uk-first-column"><a href="tel:{{env('APP_PHONE')}}"><span class="uk-margin-small-right in-icon-wrap circle small"><i class="fas fa-phone-alt"></i></span>{{env('APP_PHONE')}}</a></li>
                            @endif
                            @if(env('MAIL_FROM_ADDRESS'))
                                <li><a href="mailto:{{env('MAIL_FROM_ADDRESS')}}"><span class="uk-margin-small-right in-icon-wrap circle small"><i class="fas fa-envelope-open-text"></i></span>{{env('MAIL_FROM_ADDRESS')}}</a></li>
                            @endif
                            <li class="uk-margin-small-top uk-first-column"><a href="?livechat"><span class="uk-margin-small-right in-icon-wrap circle small"><i class="fas fa-comment-dots"></i></span>Live Chat Support</a></li>
                        </ul>
                    </div>
                </div>
            </div>
